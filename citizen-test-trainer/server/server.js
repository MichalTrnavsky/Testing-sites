...
const PUBLIC_PAGES = ["/", "/index.sv.html", "/ar", "/trainer.html", "/trainer.sv.html"];

// Clean URL for the Arabic landing.
app.get("/ar", (_req, res) => res.sendFile(path.join(APP_DIR, "index.ar.html")));
